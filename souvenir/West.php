<?php
$stmt = $pdo->prepare('SELECT * FROM products where id in (45,46,47)');
$stmt->execute();
...
<?php
$stmt = $pdo->prepare('SELECT * FROM products where id in (48,49,50)');
$stmt->execute();
$recently_added_products = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<div class="recentlyadded content-wrapper">
...
<?php
$stmt = $pdo->prepare('SELECT * FROM products where id in (51,52,53)');
$stmt->execute();
$recently_added_products = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<div class="recentlyadded content-wrapper">
...
<?php
$stmt = $pdo->prepare('SELECT * FROM products where id in (54,55,56,57)');
$stmt->execute();
$recently_added_products = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<div class="recentlyadded content-wrapper">
