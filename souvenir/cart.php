            ...
            <tbody>
                ...
                <tr>
                    <td class="img">
                        ...
                        <?php echo '<img src="data:image/png;base64,'.base64_encode($product['img']).'"/ width=50 height=50>'; ?>
                        </a>
                    </td>
                    <td>
                    ...
                    <td class="quantity">
                        <input type="number" name="quantity-<?=$product['id']?>" value="<?=$products_in_cart[$product['id']]?>" min="1" max="<?=$product['quantity']?>" placeholder="Quantity" onchange="myFun()" required>
                    </td>
