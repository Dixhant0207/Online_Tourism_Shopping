<?php
$stmt = $pdo->prepare('SELECT * FROM products where id in (21,22,15)');
$stmt->execute();
...
<?php
$stmt = $pdo->prepare('SELECT * FROM products where id in (23,24,25)');
$stmt->execute();
$recently_added_products = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<div class="recentlyadded content-wrapper">
...
<?php
$stmt = $pdo->prepare('SELECT * FROM products where id in (26,27)');
$stmt->execute();
$recently_added_products = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<div class="recentlyadded content-wrapper">
...
<?php
$stmt = $pdo->prepare('SELECT * FROM products where id in (28,29,30)');
$stmt->execute();
$recently_added_products = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>
<div class="recentlyadded content-wrapper">
